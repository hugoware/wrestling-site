...
import photogall from './photogallsample.png'
  ...
  return ( 
    ...
    <Layout disableTopMargin={true}>
          ...
          <div className="relative">
            <img className="grayscale backdrop-blur height-100% object-fill " src={Cgc.src}/>
            <img className="grayscale backdrop-blur height-100% object-fill lg:hidden md:contents" src={teamPicUrl.src}/>
            <img className="grayscale backdrop-blur height-100% object-fill lg:hidden md:contents" src={photogall.src}/>
            <div className="bg-white text-center p-8 rounded-lg opacity-80 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              ...
              <p className=" md:text-center">Our main goal of this website is to allow wrestling athletes to be able to reflect on their matches and wrestling so they can figure out ways for them to improve</p>
